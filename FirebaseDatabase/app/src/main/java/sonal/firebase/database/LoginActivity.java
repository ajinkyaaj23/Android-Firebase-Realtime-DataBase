...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private String emailId, password, role;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbData = String.valueOf(mDatabase.child("Sonal").getDatabase());
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try{
                ...
                for (int i=0; i < jsonArray.length(); i++ ){
                    ...
                    if (mEmail.equalsIgnoreCase(jsonObject.getString("userName"))
                            && mPassword.equalsIgnoreCase(jsonObject.getString("password"))){
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(LoginActivity.this,"Error in retrieving firebase database.",Toast.LENGTH_SHORT).show();
                    }
                });
